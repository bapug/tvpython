...
const document_root = '..'
const dj_root = resolve(__dirname, '../../django_root')

const DOMAIN = process.env.DOMAIN || 'bapug.local'
...
const files = glob.sync(resolve(__dirname, '../../django_root/frontend/static/scss/[^_]*.scss'))
